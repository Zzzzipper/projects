...
{
public:
    Function(ldd::Library* library, std::string name)
        : m_name(name)
    {
        m_lib = library;
        if (library == NULL)
    ...
    Function(ldd::Library* library, unsigned int ordinal)
