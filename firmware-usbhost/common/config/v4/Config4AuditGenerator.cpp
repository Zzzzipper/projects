#include "Config4AuditGenerator.h"
#include "dex/DexProtocol.h"
#include "logger/include/Logger.h"

Config4AuditGenerator::Config4AuditGenerator(Config4Modem *config) :
...
Config4AuditGenerator::~Config4AuditGenerator() {
	delete this->product;
}

void Config4AuditGenerator::reset() {
	state = State_Header;
	next();
}

void Config4AuditGenerator::next()  {
	switch(state) {
		case State_Header: {
			generateHeader();
			state = State_Main;
...
bool Config4AuditGenerator::isLast() {
...
DXE*1*1
*/
void Config4AuditGenerator::generateMain() {
...
void Config4AuditGenerator::generateCoinChanger() {
...
void Config4AuditGenerator::generateProducts() {
	startBlock();
#if 1
...
void Config4AuditGenerator::generateProductPrices() {
