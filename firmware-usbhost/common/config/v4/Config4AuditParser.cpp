...
Config4AuditParser::Config4AuditParser(Config4Modem *config) :
	Evadts::Parser(),
	config(config) {
	product = config->getAutomat()->createIterator();
}

Config4AuditParser::~Config4AuditParser() {
	delete product;
}

void Config4AuditParser::procStart() {
...
void Config4AuditParser::procComplete() {
	LOG_DEBUG(LOG_EVADTS, "complete");
	config->save();
}

bool Config4AuditParser::procLine(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parseAM2(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parseAM3(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parseID1(char **tokens, uint16_t tokenNum) {
	enum {
		ID1_AutomatId = 6
	};
...
bool Config4AuditParser::parseID4(char **tokens, uint16_t tokenNum) {
	enum {
		ID4_DecimalPoint = 1
	};
...
#if 0
bool Config4AuditParser::parseLA1(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parsePA1(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parsePA2(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parsePA4(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parsePA7(char **tokens, uint16_t tokenNum) {
...
bool Config4AuditParser::parsePA9(char **tokens, uint16_t tokenNum) {
