#include "Config4ConfigIniter.h"
#include "utils/include/Number.h"
#include "logger/include/Logger.h"

#include <string.h>

Config4ConfigIniter::Config4ConfigIniter() :
	Evadts::Parser()
{
}

void Config4ConfigIniter::procStart() {
	LOG_DEBUG(LOG_EVADTS, "procStart");
	paymentBus = Config4Automat::PaymentBus_None;
	prices.clear();
...
void Config4ConfigIniter::procComplete() {
...
bool Config4ConfigIniter::procLine(char **tokens, uint16_t tokenNum) {
...
bool Config4ConfigIniter::parseAC2(char **tokens, uint16_t tokenNum) {
...
bool Config4ConfigIniter::parseIC4(char **tokens, uint16_t tokenNum) {
	enum {
		IC4_DecimalPoint = 1
	};
...
bool Config4ConfigIniter::parsePC1(char **tokens, uint16_t tokenNum) {
...
bool Config4ConfigIniter::parsePC7(char **tokens, uint16_t tokenNum) {
...
bool Config4ConfigIniter::parsePC9(char **tokens, uint16_t tokenNum) {
