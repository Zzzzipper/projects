...
#define EVENT_LIST_SIZE 200
#else
#define EVENT_LIST_SIZE 100
#endif

Config4Modem::Config4Modem(Memory *memory, RealTimeInterface *realtime, StatStorage *stat) :
	memory(memory),
	realtime(realtime),
	stat(stat),
	address(0),
...
Config4Modem::~Config4Modem() {
	delete product;
}

MemoryResult Config4Modem::init() {
...
MemoryResult Config4Modem::load() {
...
MemoryResult Config4Modem::save() {
...
MemoryResult Config4Modem::reinit() {
...
Evadts::Result Config4Modem::comparePlanogram(Config3PriceIndexList *prices, Config3ProductIndexList *products) {
...
bool Config4Modem::asyncComparePlanogramStart(Config3PriceIndexList *prices, Config3ProductIndexList *products) {
...
bool Config4Modem::asyncComparePlanogramProc() {
...
Evadts::Result Config4Modem::asyncComparePlanogramResult() {
	return result2;
}

bool Config4Modem::isResizeable(Config3PriceIndexList *prices, Config3ProductIndexList *products) {
	(void)prices;
...
Evadts::Result Config4Modem::resizePlanogram(Config3PriceIndexList *prices, Config3ProductIndexList *products) {
...
bool Config4Modem::asyncResizePlanogramStart(Config3PriceIndexList *prices, Config3ProductIndexList *products) {
...
bool Config4Modem::asyncResizePlanogramProc() {
	LOG_DEBUG(LOG_CFG, "asyncResizePlanogramProc");
	if(automat.asyncInitProc(memory) == true) {
		return true;
	}
...
Evadts::Result Config4Modem::asyncResizePlanogramResult() {
	return result2;
}
