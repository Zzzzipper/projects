...
//todo: есть мысль упорядочить ошибки в соответствии с EVADTS и коды из стандарта задавать, начиная с 0xXX81
		// door
		Type_EGS_DoorOpen			= 0x0701, // Дверь открыта
		Type_EGS_DoorClose			= 0x0702, // Дверь закрыта
		// cup system
		Type_EBJ_NoCups				= 0x0801, // Нет стаканов
		// water system
		Type_EFL_NoWater			= 0x0901, // Нет воды
		Type_OBI_WasteWaterPipe		= 0x0902, // Переполнено ведро отходов
		// coffee brewer
		Type_EEA_CoffeeMotorFault	= 0x0A01, // Сбой кофейного мотора
		// hot drink system
		Type_ED_HotDrinkFault		= 0x0B01, // Сбой системы горячих напитков
		Type_EDT_Grinder			= 0x0B02, // Сбой кофемолки
		// debug
