#ifndef COMMON_CONFIG_PRODUCT_H_
#define COMMON_CONFIG_PRODUCT_H_
...
class Config3ProductIterator {
public:
	Config3ProductIterator(Config3PriceIndexList *priceIndexes, Config3ProductIndexList *productIndexes, Config3ProductList *products);
	bool first();
	bool last();
	bool prev();
	bool next();
