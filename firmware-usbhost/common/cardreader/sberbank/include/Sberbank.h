#ifndef COMMON_SBERBANK_H
#define COMMON_SBERBANK_H
...
public:
	Cashless(Mdb::DeviceContext *context, AbstractUart *uart, TcpIp *conn, TimerEngine *timers, EventEngineInterface *eventEngine, uint32_t maxCredit);
	virtual ~Cashless();
