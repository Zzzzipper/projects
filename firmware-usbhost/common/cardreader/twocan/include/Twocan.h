#ifndef COMMON_TWOCAN_H
#define COMMON_TWOCAN_H
...
public:
	Cashless(Mdb::DeviceContext *context, AbstractUart *uart, TcpIp *tcpIp, TimerEngine *timers, EventEngineInterface *eventEngine, uint32_t credit);
	virtual ~Cashless();
