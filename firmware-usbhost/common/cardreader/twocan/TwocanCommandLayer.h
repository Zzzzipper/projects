#ifndef COMMON_TWOCAN_COMMANDLAYER_H
#define COMMON_TWOCAN_COMMANDLAYER_H

#if 1
#include "TwocanPacketLayer.h"
#include "TwocanProtocol.h"
#include "TwocanDeviceLan.h"
...
public:
	CommandLayer(Mdb::DeviceContext *context, PacketLayerInterface *packetLayer, TcpIp *conn, TimerEngine *timers, EventEngineInterface *eventEngine, uint32_t credit);
	...
	bool parse(const uint8_t *data, const uint16_t dataLen);
