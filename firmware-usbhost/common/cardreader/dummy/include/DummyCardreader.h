#ifndef COMMON_CARDREADER_DUMMY_H
#define COMMON_CARDREADER_DUMMY_H
...
public:
	Cashless(Mdb::DeviceContext *context, AbstractUart *uart, TcpIp *tcpIp, TimerEngine *timerEngine, EventEngineInterface *eventEngine);
	virtual ~Cashless();
