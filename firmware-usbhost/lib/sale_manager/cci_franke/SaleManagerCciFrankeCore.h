#ifndef LIB_SALEMANAGER_CCIFRANKE_CORE_H_
#define LIB_SALEMANAGER_CCIFRANKE_CORE_H_
...
class SaleManagerCciFrankeCore : public EventSubscriber {
public:
	SaleManagerCciFrankeCore(ConfigModem *config, ClientContext *client, TimerEngine *timers, EventEngineInterface *eventEngine, MdbSlaveCashlessInterface *slaveCashless, MdbMasterCashlessStack *masterCashlessStack, Fiscal::Register *fiscalRegister);
	~SaleManagerCciFrankeCore();
	virtual void reset();
