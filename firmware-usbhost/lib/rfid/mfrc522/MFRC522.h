...
//	MFRC522(uint8_t chipSelectPin, uint8_t resetPowerDownPin);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	virtual void PCD_WriteRegister(uint8_t reg, uint8_t value) = 0;
	virtual void PCD_WriteRegister(uint8_t reg, uint8_t count, uint8_t *values) = 0;
	virtual uint8_t PCD_ReadRegister(uint8_t reg) = 0;
	virtual void PCD_ReadRegister(uint8_t reg, uint8_t count, uint8_t *values, uint8_t rxAlign = 0) = 0;
	virtual void setResetPin(bool hiLevel) = 0;
