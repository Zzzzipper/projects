...
//#define NO_DH //mbed
//#define HAVE_ECC // модный алгоритм обмена ключами, при попытке включения упало, возможно не хватило памяти
#define WOLFSSL_STATIC_RSA // устаревший алгоритм обмена ключами
...
// optimization
#define NO_MD4
//#define NO_SHA512 //mbed
//#define NO_DSA //mdbed
//#define WOLFSSL_BASE64_ENCODE //mbed
#define NO_DES3
#define NO_RC4
#define NO_HC128
#define WC_NO_RSA_OAEP
#define WC_NO_HARDEN
//#define RSA_LOW_MEM // замедляет расчет RSA в 8 раз!
#define TFM_TIMING_RESISTANT // замедляет все расчеты в 2 раза, но и уменьшает размер памяти в 2 раза
