...
func (this *Modules) RegisterAction_SettingsGeneral() *Action {
	return this.newAction(AInfo{
		...
		pf_mod_enabled_empty_pass := utils.Trim(wrap.R.FormValue("mod-enabled-security"))
		...
		pfi_mod_enabled_empty_pass := utils.StrToInt(pf_mod_enabled_empty_pass)
		...
		(*wrap.Config).Modules.Enabled.EmptyPassword = pfi_mod_enabled_empty_pass
