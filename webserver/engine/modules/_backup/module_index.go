...
func (this *Modules) RegisterModule_Index() *Module {
	return this.newModule(MInfo{
		...
		Name:  "Страницы",
		Order: 0,
		Icon:  "<i class=\"material-icons notranslate\">pages</i>", //assets.SysSvgIconPage,
		Sub: &[]MISub{
			{Mount: "default", Name: "Список страниц", Show: true, Icon: "<i class=\"material-icons notranslate\">list</i>" /*assets.SysSvgIconList*/},
			{Mount: "add", Name: "Добавить страницу", Show: true, Icon: "<i class=\"material-icons notranslate\">add</i>" /*assets.SysSvgIconPlus*/},
		...
		err := wrap.DB.QueryRow(
			...
			`SELECT
				...
				pages.meta_keywords,
				pages.meta_description,
				strftime('%s', pages.datetime) as datetime,
				pages.active,
				users.id,
				users.first_name,
				users.last_name,
