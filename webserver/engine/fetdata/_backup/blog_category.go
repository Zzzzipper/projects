...
type BlogCategory struct {
	...
	object *utils.Sql_blog_category

	user *User

	bufferCats map[int]*utils.Sql_blog_category
}

func (this *BlogCategory) load(cache *map[int]*utils.Sql_blog_category) *BlogCategory {
	if this == nil {
		return this
	}
	...
	if this.bufferCats == nil {
		this.bufferCats = map[int]*utils.Sql_blog_category{}
	}
...
func (this *BlogCategory) loadById(id int) {
	...
	this.object = &utils.Sql_blog_category{}
