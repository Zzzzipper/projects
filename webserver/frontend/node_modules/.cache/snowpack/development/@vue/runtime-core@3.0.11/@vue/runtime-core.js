import { pauseTracking, resetTracking, isRef, toRaw, stop, isReactive, effect, ref, isProxy, shallowReadonly, computed as computed$1, track, proxyRefs, isReadonly, shallowReactive, trigger, toRef, reactive } from '@vue/reactivity';
export { customRef, isProxy, isReactive, isReadonly, isRef, markRaw, proxyRefs, reactive, readonly, ref, shallowReactive, shallowReadonly, shallowRef, toRaw, toRef, toRefs, triggerRef, unref } from '@vue/reactivity';
import { isString, isFunction, isPromise, extend, remove, EMPTY_OBJ, isArray, isObject, getGlobalThis, capitalize, EMPTY_ARR, normalizeClass, normalizeStyle, isOn, NOOP, isGloballyWhitelisted, toHandlerKey, toNumber, hasChanged, isSet, isMap, invokeArrayFns, isReservedProp, camelize, hasOwn, NO, hyphenate, isModelListener, def, toRawType, makeMap } from '@vue/shared';
